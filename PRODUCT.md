...
- The four `liveUrl` fields in `data/projects.ts` (`*.velocestudio.tech` subdomains fronting the Netlify deploys) do point to real, running demo deployments of the example apps, even though the "clients" behind them are illustrative.
